...
<html>
	...
	<body>
		<div id="wrapper">
			...
			<div id="menu">
				<a href="index.php">Home</a><a href="login.php">Login</a><a href="register.php">Register</a><a href="aboutus.php" class="selected">About</a><a href="contactus.php">Contact</a>
			</div>
